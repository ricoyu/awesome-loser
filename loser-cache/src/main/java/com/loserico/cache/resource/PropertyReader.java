package com.loserico.cache.resource;

import com.loserico.cache.utils.CollectionUtils;
 ...
 * 负责读取属性文件
 * <p>
 * Copyright: Copyright (c) 2019-10-17 13:43
 * <p>
...
public class PropertyReader {
	...
	public Set<String> getStringAsSet(String property) {
		...
		return CollectionUtils.newHashSet(arr);
	}
